                ...
                <div key={expense.id} className="p-5 hover:bg-slate-50/70 transition flex flex-col md:flex-row md:items-start justify-between gap-5">
                  <div className="space-y-3 max-w-3xl flex-1">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="md:hidden text-lg font-black text-amber-600 flex items-center shrink-0">
                  ...
                  {/* Right side / Bottom row: Action buttons and Desktop Amount */}
                  <div className="flex flex-col md:items-end justify-between gap-3 shrink-0 pt-3 md:pt-0 border-t md:border-t-0 border-slate-100 w-full md:w-auto">
                    {/* Desktop Amount (Hidden on mobile) */}
                    <div className="hidden md:flex text-2xl font-black text-amber-600 items-center">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                      ...
                      <button
                        ...
                        className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl border border-emerald-300 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 font-bold text-xs transition cursor-pointer shadow-2xs active:scale-95"
                      ...
                      {isAdminLoggedIn && onDeleteExpense && (
                        <button
                          ...
                          className="flex-1 md:flex-initial inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl border border-rose-200 text-rose-700 bg-rose-50 hover:bg-rose-100 font-bold text-xs transition cursor-pointer shadow-2xs active:scale-95"
